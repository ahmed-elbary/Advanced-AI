...
# %%
file_path = r'C:\Users\Student\Downloads\AAI-assignment-main\AAI-assignment-main\Datasets and old trials\dementia_data-MRI-features.csv'  # Replace with your local file path
