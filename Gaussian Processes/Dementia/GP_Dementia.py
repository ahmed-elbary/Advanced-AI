...
data = pd.read_csv(r'C:\Users\amroh\Desktop\Ahmed\AAI\AAI-assignment\AAI-assignement-main\AAI-assignement-main\Datasets and old trials\dementia_data-MRI-features.csv')
