...
###################################################################################################
# Load the dataset
file_path = r'C:\CloudDriveSpace\OneDrive\29385647@students.lincoln.ac.uk\Desktop\AAI-assignment\Datasets and old trials\parkinsons_data-VOICE-features.csv'
